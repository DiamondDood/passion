class LevelParentScene extends Phaser.Scene {
    ...
    create(mapname) {
        ...
        this.worldLayer = map.createStaticLayer("World2", tileset, 0, 0);
    ...
    update(delta) {
        ...
        else if (this.keys.key_D.isDown || this.keys.key_right.isDown || (this.input.mousePointer.leftButtonDown() && this.input.mousePointer.isDown)) 
        {
            this.moveRight();
        }
        else {
        ...
        if ((this.keys.key_W.isDown || this.keys.key_up.isDown || (this.input.mousePointer.rightButtonDown() && this.input.mousePointer.isDown)) && this.player.body.blocked.down)
        {
