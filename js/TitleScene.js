class TitleScene extends Phaser.Scene {
    ...
    preload() {
        ...
        var textElement = this.add.text(width/2,height/2-150, 'Bryce Personal Passion!', textStyle);
        ...
        var textElement = this.add.text(width/2,height/2-60, 'Directions: WASD, arrow keys, or mouse buttons to move', textStyle);
        textElement.setOrigin(0.5, 0.5);
        ...
        this.load.image("tiles", "assets/shawn.png");
        this.load.image("tiles", "assets/ifstatement.png");
